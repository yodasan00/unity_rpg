...
//     // Stores keys like "Semester1_ProgrammingLab"
//     public List<string> completedLabs = new List<string>();    
//     public List<string> completedQuests = new List<string>();
...
//     // --- Lab Completion (semester-specific) ---
//     public bool HasCompletedLab(string labKey)
//     {
//         return completedLabs.Contains(labKey);
//     }

//     public void MarkLabCompleted(string labKey)
//     {
//         if (!completedLabs.Contains(labKey))
//             completedLabs.Add(labKey);
//     }
